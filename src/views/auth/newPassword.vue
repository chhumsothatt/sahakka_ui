                ...
                <div class="row g-0 verify-card">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="form-panel">
                            ...
                            <button class="btn btn-verify" @click="handleNewPassword" id="verifyBtn">
...
const handleNewPassword = async () => {
    ...
    if (!email.value.trim()) emailErr.value = "Email is required";
    if (!newpassword.value.trim()) newPasswordErr.value = "new password is required";
    if (!confirmpassword.value.trim()) confirmPasswordErr.value = "confirm password is required";
    if (newpassword.value.length < 8) newPasswordErr.value = "Password must be at least 8 characters";
    if (newpassword.value !== confirmpassword.value) confirmPasswordErr.value = "Passwords do not match";

    if (emailErr.value || newPasswordErr.value || confirmPasswordErr.value) {
        return;
    }
    ...
    try {
        ...
        toast.success("Password changed successfully", "/login");
    } catch (error) {
